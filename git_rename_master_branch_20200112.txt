...
gitlab web 右上角的setting裡 protected branched -> unprotect the master branch
...
gitlab web 右上角的setting裡 protected branched -> protect the "default" branch
gitlab web 右上角的setting裡 edit project -> choose the "default" branch for Default Branch setting

step5: [optional] set the remotes/origin/HEAD
git remote set-head origin -a
git branch -a

step6: delete master branch
